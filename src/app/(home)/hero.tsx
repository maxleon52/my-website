...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="h-[178px] w-[600px] pt-12">
        <h1
          id="hero-h1-maxwell"
          className="animate-growth-color font-science-personal-use-only from-max-blue-700 to-max-blue-500 hover:!text-max-blue-200 bg-gradient-to-br bg-clip-text text-9xl text-transparent"
        >
          Maxwell
        </h1>
      </div>
      ...
      <div className="h-9 w-[280px]">
        <h2 id="hero-h2-frontend" className="text-3xl">
          Front-end Developer
        </h2>
      </div>
